#!/usr/bin/env python3
"""
Head Motor Test - Quick test for head motor only with PWM
"""
import time
import lgpio
...
try:
    ...
    print("Head motor ON (100% power, 3 seconds)...")
    # PWM with 100% duty cycle = full power
