...
from ..config import OPENAI_API_KEY, OPENAI_MODEL, REALTIME_AI_PROVIDER, XAI_API_KEY, OLLAMA_MODEL, WHISPER_MODEL, TTS_VOICE
...
try:
    local_provider = LocalProvider(ollama_model=OLLAMA_MODEL, whisper_model=WHISPER_MODEL, tts_voice=TTS_VOICE)
